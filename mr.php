...
?>
    ...
    <form method="post" class="for-groub">
      ...
      <button type="submit" name="for_add_exam" class="fields feild-2"> <i class="fa fa-clipboard-list"></i> إضافة امتحانات</button>
      <button type="submit" name="for_students_marks" class="fields feild-3"> <i class="fa fa-scroll"></i> درجات الطلاب</button>
      <button type="submit" name="for_students_add_video" class="fields feild-4"> <i class="fa fa-video"></i> إضافة فيديو</button>
      <button type="submit" name="for_students_message" class="fields feild-5"> <i class="fa fa-envelope"></i> إرسال رسالة</button>
      <button type="submit" name="for_add_student" class="fields feild-6"> <i class="fa fa-plus"></i> إضافة طلاب</button>
      <button type="submit" name="for_add_photo" class="fields feild-7"> <i class="fa fa-camera"></i> إضافة صورة</button>
      <button type="submit" name="for_pdf" class="fields feild-8"> <i class="fa fa-file-pdf"></i> إضافة PDF</button>
          ...
          ?>
            ...
            <form method="post" class="add-form" enctype="multipart/form-data">
              ...
              <div class="add-groub">
                ...
                <input type="text" class="input" name="add_name_for_image" placeholder="عنوان للصورة التي ستظهر للطلاب كملف للصور..." value="<?php if(isset($name_for_image)){echo $name_for_image;}?>">
                <i class="fa fa-photo-video fa-fw icons"></i>
              </div>
              <hr>
              <div class="add-groub">
                <lable class="txt">وصف دقيق للصورة</lable>
                <input type="text" class="input" name="add_dis_for_image" placeholder="ضع وصفا يفهم منه الطلاب الاشياء المهمه" value="<?php if(isset($disc_for_image)){echo $disc_for_image;} ?>">
                <i class="fa fa-cogs fa-fw icons"></i>
              </div>
              <hr>
              <div class="add-groub">
